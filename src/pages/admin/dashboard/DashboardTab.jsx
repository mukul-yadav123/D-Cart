...
function DashboardTab() {
    const { user,order,mode,product,editHandle,deleteProduct} = useData();
    // console.log(user);
                                ...
                                <div className="relative overflow-x-auto ">
                                    <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400  ">
                                        ...
                                        </thead>
                                        {
                                            ...
                                            {
                                                const {title,price,imageUrl,category,date} = item.data();
                                                return (
                                                    <tbody className='' key={ind}>
                            ...
                            <div className="relative overflow-x-auto mb-16">
                                <h1 className=' text-center mb-5 text-3xl font-semibold underline' style={{ color: mode === 'dark' ? 'white' : '' }}>Order Details</h1>
                              {
                                order.map((allOrder,ind) => {
                                    const {addressInfo: {address,pincode,name,phoneNumber}, cartItems,email,date,paymentId} = allOrder;
                                    return (
                                        <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400" >
                                        ...
                                        <tbody>
                                                    ...
                                                    <tr className="bg-gray-50 border-b  dark:border-gray-700" style={{ backgroundColor: mode === 'dark' ? 'rgb(46 49 55)' : '', color: mode === 'dark' ? 'white' : '', }} >
                                                        ...
                                                        <th scope="row" className="px-6 py-4 font-medium text-black whitespace-nowrap">
                                                            <img className='w-16' src={cartItems[0].imageUrl} alt="img" />
                                                        </th>
                                                        <td className="px-6 py-4 text-black " style={{ color: mode === 'dark' ? 'white' : '' }}>
                                                            {cartItems[0].title}
                                                        </td>
                        ...
                        <TabPanel>
                            ...
                            <div className="relative overflow-x-auto mb-10">
                                ...
                                <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                    ...
                                    {
                                        user.map((allUser,ind) => {
                                            console.log(allUser);
                                            const {name,email,uid} = allUser;
                                            return (
                                                <tbody key={ind}>
                                                <tr className="bg-gray-50 border-b  dark:border-gray-700" style={{ backgroundColor: mode === 'dark' ? 'rgb(46 49 55)' : '', color: mode === 'dark' ? 'white' : '', }} >
                                                <td className="px-6 py-4 text-black " style={{ color: mode === 'dark' ? 'white' : '' }}>
