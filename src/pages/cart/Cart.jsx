...
function Cart() {
  ...
  const shipping = cartItems.length != 0 ? parseInt(100) : parseInt(0);
  ...
  const buyNow = () =>
  {
    if (name === "" || address == "" || pincode == "" || phoneNumber == "") {
      ...
      var options = {
        key: "rzp_test_amgvgVlWhZ0epI",
        key_secret: "Vv1p0zXTiptsiiXBdDugHtS2",
        ...
        <div className="mx-auto max-w-5xl justify-center px-6 md:flex md:space-x-6 xl:px-0">
          <div className="rounded-lg md:w-2/3 overflow-hidden ">
            {
              cartItems.map((item,ind) => {
                ...
                return (
                  <div key={ind} className="justify-between mb-6 rounded-lg border  drop-shadow-xl bg-white p-6  sm:flex  sm:justify-start" style={{ backgroundColor: mode === 'dark' ? 'rgb(32 33 34)' : '', color: mode === 'dark' ? 'white' : '', }}>
              ...
              <div className="sm:ml-4 sm:flex sm:w-full sm:justify-between">
                ...
                <div onClick={() => deleteItem(item)} className="mt-4 flex justify-between sm:space-y-6 sm:mt-0 sm:block sm:space-x-6 cursor-pointer">
          ...
          <div className="mt-6 h-full rounded-lg border bg-white p-6 shadow-md md:mt-0 md:w-1/3" style={{ backgroundColor: mode === 'dark' ? 'rgb(32 33 34)' : '', color: mode === 'dark' ? 'white' : '', }}>
            ...
            <div className="flex justify-between">
              ...
              <p className="text-gray-700" style={{ color: mode === 'dark' ? 'white' : '' }}>{cartItems.length != 0 ? '₹ 100' : '₹ 0'}</p>
            </div>
            <hr className="my-4" />
