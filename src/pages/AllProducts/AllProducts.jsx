...
const AllProducts = () => {
    ...
    const {mode,product,loading} = useData();
         ...
         <section className="text-gray-600 body-font">
            ...
            <div className="container px-5 py-8 md:py-16 mx-auto">
                <div className="lg:w-1/2 w-full mb-6 lg:mb-10">
                    <h1 className="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900" style={{ color: mode === 'dark' ? 'white' : '' }}>All Products</h1>
