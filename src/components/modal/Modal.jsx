...
export default function Modal(props) {
    const{name,address,pincode,phoneNumber,setName,setAddress,setPincode,setPhoneNumber,buyNow} = props
                                                ...
                                                <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                                                    ...
                                                    <form className="space-y-4 md:space-y-6" action="#">
                                                        ...
                                                        <div>
                                                            ...
                                                            <input value={pincode} type="text" name="pincode" onChange={(e) => setPincode(e.target.value)} id="pincode" className=" border outline-0 border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 bg-gray-100" required />
                                                        </div>
                                                        <div>
